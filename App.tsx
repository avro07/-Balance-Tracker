          ...
          <div className="fixed bottom-4 left-4 right-4 z-10">
            <div className="max-w-md mx-auto flex justify-center items-center gap-3">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 py-2 px-3 text-sm bg-gradient-to-br from-sky-500 to-blue-500 dark:from-cyan-700 dark:to-blue-800 text-white font-medium rounded-lg shadow-md shadow-sky-500/20 dark:shadow-cyan-900/30 hover:-translate-y-0.5 transform transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-offset-slate-900 border border-transparent dark:border-cyan-500/30"
              >
                <ExportIcon />
                <span>Export</span>
              </button>
