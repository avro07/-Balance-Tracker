...
export const BankIconSimple: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 10h18M3 6l9-4 9 4M4 10v11h16V10M19 21v-9a2 2 0 00-2-2H7a2 2 0 00-2 2v9"/>
    </svg>
);
...
export const NagadIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#clip0_105_2)">
            <path d="M12 24C18.6274 24 24 18.6274 24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 18.6274 5.37258 24 12 24Z" fill="#F58220"></path>
            <path d="M11.9999 15.684C8.84793 15.684 6.31592 13.152 6.31592 10.0001C6.31592 6.84807 8.84793 4.31604 11.9999 4.31604C14.7359 4.31604 16.9439 6.22407 17.5199 8.73609L14.4239 9.3121C14.2319 8.3521 13.2079 7.6321 11.9999 7.6321C10.5119 7.6321 9.31191 8.8321 9.31191 10.3201C9.31191 11.8081 10.5119 13.0081 11.9999 13.0081C13.2079 13.0081 14.2319 12.2881 14.4239 11.3281L17.5199 11.9041C16.9439 14.4161 14.7359 15.684 11.9999 15.684Z" fill="white"></path>
            <path d="M17.6841 8.73609C17.6841 8.73609 17.5199 8.73609 17.5199 8.73609L14.4239 9.3121C14.2319 8.3521 13.2079 7.6321 11.9999 7.6321C10.5119 7.6321 9.31191 8.8321 9.31191 10.3201C9.31191 11.8081 10.5119 13.0081 11.9999 13.0081C13.2079 13.0081 14.2319 12.2881 14.4239 11.3281L17.5199 11.9041C17.5199 11.9041 17.6841 11.9041 17.6841 11.9041C18.9801 11.9041 20.0001 13.1041 20.0001 14.4V19.68H17.2801V14.76C17.2801 14.28 16.8001 13.8 16.3201 13.8H15.6C15.1201 13.8 14.6401 14.28 14.6401 14.76V19.68H4V14.76C4 14.28 4.47999 13.8 4.95999 13.8H5.28C5.76 13.8 6.24 14.28 6.24 14.76V19.68H9V14.76C9 14.28 9.47999 13.8 9.95999 13.8H10.28C10.76 13.8 11.24 14.28 11.24 14.76V19.68H12.6V14.76C12.6 13.56 13.56 12.6 14.76 12.6H17.6841C17.6841 11.2561 17.6841 8.73609 17.6841 8.73609Z" fill="#F58220"></path>
        </g>
    </svg>
);
